...
import SingleColumnProjectCard from './SingleColumnProjectCard'
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            'AI-powered file organization that understands your content and makes finding files effortless.',
        technologies: [
            'AI',
            'File Management',
            'User Experience',
    ...
    },
    {
        ...
        description:
            'B2B project and workload management tool, focused on enterprise clients and team alignment.',
        technologies: [
            'SaaS',
            'Productivity',
            'Enterprise',
                            ...
                            projects.map((project, index) => (
                                ...
                                >
                                    {project.isComingSoon ? (
                                        ...
                                        />
                                    ) : project.isSingleColumn ? (
                                        <SingleColumnProjectCard
                                            title={project.title}
                                            description={project.description}
                                            tags={project.technologies}
                                            link={project.link}
